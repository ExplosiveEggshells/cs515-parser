...
private:
     ...
     * 
     * A large part of my understanding for creating a working grammar came from:
     * https://www.cs.auckland.ac.nz/courses/compsci220s1t/archive/compsci220ft/lectures/GGlectures/220ch4_gramm.pdf
     * 
     * So the terms given for these functions will look similar to the lecture given there,
     * but no code for recursive descent was given there, so it's all from yours truly.
     */
